...
import { generateHeatmapData } from "@/data/tracks";
...
export function ActivityHeatmap({ className }) {
  // Generate once — avoids reshuffling the random mock on every render.
  const data = React.useMemo(() => generateHeatmapData(), []);
