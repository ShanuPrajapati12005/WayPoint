...
export const TRACKS = {
  ml: {
    ...
    status: 'active',
    nodeMap: {
      f1: { title: 'Python Basics', status: 'completed', match: 96, duration: '2 wks', stage: 'learn' },
      f2: { title: 'Statistics 101', status: 'completed', match: 91, duration: '2 wks', stage: 'learn' },
      f3: { title: 'SQL for Data', status: 'in_progress', match: 88, duration: '1.5 wks', stage: 'learn' },
      d1: { title: 'Pandas & NumPy', status: 'not_started', match: 93, duration: '2 wks', stage: 'build' },
      d2: { title: 'Data Visualization', status: 'not_started', match: 85, duration: '1 wk', stage: 'build' },
      m1: { title: 'ML Fundamentals', status: 'not_started', match: 90, duration: '3 wks', stage: 'learn' },
      m2: { title: 'Model Evaluation', status: 'not_started', match: 82, duration: '1.5 wks', stage: 'prove' },
      m3: { title: 'Capstone Project', status: 'not_started', match: 97, duration: '2 wks', stage: 'prove' },
    },
    skillData: [
  ...
  python: {
    ...
    status: 'completed',
    nodeMap: {
      f1: { title: 'Python Syntax', status: 'completed', match: 98, duration: '1 wk', stage: 'learn' },
      f2: { title: 'Functions & Modules', status: 'completed', match: 97, duration: '1 wk', stage: 'learn' },
      f3: { title: 'File Handling', status: 'completed', match: 95, duration: '0.5 wk', stage: 'learn' },
      d1: { title: 'OOP in Python', status: 'completed', match: 96, duration: '1 wk', stage: 'build' },
      d2: { title: 'Error Handling', status: 'completed', match: 94, duration: '0.5 wk', stage: 'build' },
      m1: { title: 'Working with APIs', status: 'completed', match: 93, duration: '1 wk', stage: 'build' },
      m2: { title: 'Testing Basics', status: 'completed', match: 91, duration: '0.5 wk', stage: 'prove' },
      m3: { title: 'Capstone: CLI Tool', status: 'completed', match: 99, duration: '1 wk', stage: 'prove' },
    },
    skillData: [
